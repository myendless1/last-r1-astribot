...
CHECKPOINT="${CHECKPOINT:-/media/damoxing/ckp/last_r1_astribot_sft}"
...
INFERENCE_MODE="${INFERENCE_MODE:-autoregressive}"
...
echo "[astribot-eval] inference_mode=${INFERENCE_MODE} eval_dtype=${EVAL_DTYPE}"
